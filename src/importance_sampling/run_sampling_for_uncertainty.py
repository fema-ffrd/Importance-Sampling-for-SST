...
if __name__ == '__main__':
    ...
    for n_sim_is, n_iter in zip(v_n_sim_is, v_n_iter):
        ...
        # Importance Sampling
        df_depths_is_iter, df_prob_is_iter, df_aep_is_iter, df_aep_summary_is_iter = simulate_sst_iter(sp_watershed, sp_domain, df_storms, dist_x, dist_y, num_simulations=n_sim_is, num_iter=n_iter)
