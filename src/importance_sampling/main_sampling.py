...
if __name__ == '__main__':
    ...
    # pls UPDATE this: number of simulations for ground truth
    n_sim_mc = 1_000_000
    ...
    #%% Set number of simulations
    # pls UPDATE this: number of simulations for importance sampling
    n_sim_is = 5_000
    ...
    df_storm_sample_mc_1: pd.DataFrame = pd.read_pickle(f'df_storm_sample_mc_1_n_{n_sim_is}.pkl')

    df_depths_mc_0: pd.DataFrame = pd.read_pickle('df_depths_mc_0.pkl')
    df_depths_mc_1: pd.DataFrame = pd.read_pickle(f'df_depths_mc_1_n_{n_sim_is}.pkl')
...
# for choice_param_value, choice_param_value_2 in itertools.product([0.25, 0.5, 0.75, 1], [0.1, 0.2]):
    ...
    if choice_dist == 'TruncNorm':
        ...
        df_storm_sample_is_1 = pd.read_pickle(f'df_storm_sample_is_n_{n_sim_is}_tn_std_{choice_param_value}.pkl')
        df_depths_is_1 = pd.read_pickle(f'df_depths_is_n_{n_sim_is}_tn_std_{choice_param_value}.pkl')
    elif choice_dist == 'TruncGenNorm':
        beta = choice_param_value
        df_storm_sample_is_1 = pd.read_pickle(f'df_storm_sample_is_n_{n_sim_is}_tgn_beta_{choice_param_value}.pkl')
        df_depths_is_1 = pd.read_pickle(f'df_depths_is_n_{n_sim_is}_tgn_beta_{choice_param_value}.pkl')
    elif choice_dist == 'TruncT':
        mult_std = choice_param_value
        dof = choice_param_value_2
        df_storm_sample_is_1 = pd.read_pickle(f'df_storm_sample_is_n_{n_sim_is}_tt_std_{choice_param_value}_dof_{dof}.pkl')
        df_depths_is_1 = pd.read_pickle(f'df_depths_is_n_{n_sim_is}_tt_std_{choice_param_value}_dof_{dof}.pkl')
    elif choice_dist == 'TruncNorm_Unif':
        mult_std = choice_param_value
        w1 = choice_param_value_2
        df_storm_sample_is_1 = pd.read_pickle(f'df_storm_sample_is_n_{n_sim_is}_tnXu_std_{mult_std}_w1_{w1}.pkl')
        df_depths_is_1 = pd.read_pickle(f'df_depths_is_n_{n_sim_is}_tnXu_std_{mult_std}_w1_{w1}.pkl')
    ...
    # print(g)
    g.save(f'XY n_{n_sim_is} {choice_dist} {choice_param_name}_{choice_param_value}_{choice_param_name_2}_{choice_param_value_2}.png', width=10, height=7)
    ...
    # print(g)
    g.save(f'Freq n_{n_sim_is} {choice_dist} {choice_param_name}_{choice_param_value}_{choice_param_name_2}_{choice_param_value_2}.png', width=10, height=7)
